...
var AppComponent = (function () {
    function AppComponent() {
        this.title = 'Angular4 with Spring Boot';
    }
    return AppComponent;
}());
...
var UserService = (function () {
    ...
    function UserService(http) {
        this.http = http;
        this.userUrl = '/rest/user/hello?name=1';
    }
    // Get all Users
    UserService.prototype.getHelloMsg = function () {
...
var UserComponent = (function () {
    ...
    UserComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userService.getHelloMsg().then(function (user) { return _this.user = user; });
    };
